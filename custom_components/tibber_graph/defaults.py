...
X_AXIS_LABEL_FONT_SIZE = 12                 # Font size for X-axis time labels
...
Y_AXIS_LABEL_FONT_SIZE = 11                 # Font size for Y-axis tick labels
Y_AXIS_LABEL_PADDING = 3                    # Distance between tick and label (in points)
...
# Price labels
CURRENCY_OVERRIDE = None                    # Override currency (e.g., "EUR", "SEK", "NOK"). None = use Tibber home currency
...
LABEL_FONT_SIZE = 12                        # Font size for in-graph price labels (min/max/current)
