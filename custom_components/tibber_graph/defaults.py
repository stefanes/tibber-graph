...
# Refresh settings
AUTO_REFRESH_ENABLED = False                # True = automatically refresh the graph 1 minute into each pricing interval (every 15 min for 15-min pricing, every hour for hourly pricing)
