...
LABEL_CURRENT_AT_TOP = True                 # True = show current label centered at top; False = show on the graph
LABEL_CURRENT_AT_TOP_FONT_WEIGHT = "bold"   # "normal" or "bold" (for top current label)
LABEL_CURRENT_AT_TOP_PADDING = 0.09         # Vertical padding from bottom of text to top of graph area (as fraction, e.g., 0.035 = 3.5%)
