& {
    ...
    cp $repoRoot\local\local_render\local_render.png $repoRoot\docs\assets\defaults-only.png

    # Old defaults only configuration
    python $repoRoot\local\local_render\local_render.py -o -t 19:34 --publish
    cp $repoRoot\local\local_render\local_render.png $repoRoot\docs\assets\old-defaults.png

    # Wear OS configuration
    python $repoRoot\local\local_render\local_render.py -w -t 19:34 --publish
    cp $repoRoot\local\local_render\local_render.png $repoRoot\docs\assets\wearos-config.png
    ...
    cp $repoRoot\local\local_render\local_render.png $repoRoot\docs\assets\random-light.png
}
