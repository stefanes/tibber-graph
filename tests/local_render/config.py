...
# X-axis settings
# START_AT_MIDNIGHT = True  # Default: True
# SHOW_X_TICKS = True  # Default: True
# X_AXIS_BOTTOM_MARGIN = 0.25  # Default: 0.25
# X_AXIS_LABEL_FONT_SIZE = 12  # Default: 12
...
# Y_AXIS_LABEL_FONT_SIZE = 11  # Default: 11
# Y_AXIS_LABEL_PADDING = 3  # Default: 3
# Y_AXIS_LABEL_VERTICAL = False  # Default: False
# Y_AXIS_LABEL_VERTICAL_ANCHOR = False  # Default: False
# Y_AXIS_SIDE = "left"  # Default: "left"
Y_TICK_COUNT = 3  # Default: None
Y_TICK_USE_COLORS = True  # Default: False

# Price labels
# CURRENCY_OVERRIDE = None  # Default: None
# LABEL_CURRENT = True  # Default: True
# LABEL_CURRENT_AT_TOP = False  # Default: False
